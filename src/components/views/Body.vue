<template>
  <main class="body">
    ...
    <div class="row bannerCentral">
        ...
        <section style="width: 100%">
          <div style="margin: 0 auto; width: 480px">
            ...
            <h3 style="color: white" align="left">
              Aprende en cualquier momento y forma parte de esta gran comunidad
            </h3>
          </div>
          <v-container>
            <v-layout justify-center>
              <v-btn dark color="primary" flat depressed outline
                >Crea tu cuenta gratis</v-btn
              >
            </v-layout>
          </v-container>
        </section>
      ...
      <section style="width: 100%">
        <div>
          <img src="@/assets/img/barra.png" width="1350" height="" />
        </div>
      </section>
    </div>
    <div>
