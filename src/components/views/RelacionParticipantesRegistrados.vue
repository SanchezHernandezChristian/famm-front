...
export default {
  ...
  methods: {
    ...
    editItem(item) {
      ...
      this.editId = this.editedItem.idParticipante;
      console.log("editedItem.idParticipante ", this.editId);
    },
    deleteItem(item) {
      this.editedIndex = this.participantes.indexOf(item);
      ...
      this.deleteId = this.editedItem.idParticipante;
      console.log("editedItem.idParticipante ", this.deleteId);
